...
class MainContainer extends Component {
  ...
  constructor(parentNode: HTMLElement) {
    ...
    this.description = new Component(this.helloWindow.element, 'p', ['main-container__description'], 'На странице "Электронный учебник" находится 3 600 слов, которые разделены на шесть разделов в зависимости от уровня сложности. Слова, которые сложно запомнить, можно добавить в раздел "Сложные слова", чтобы сконцентрировать на них особое внимание. Также приложение оснащено двумя интересными играми для лучшего усвоения материала. Для отслеживания прогресса в изучении можно воспользоваться разделом "Статистика". Вот и вся нехитрая инструкция, удачи в изучении =)');
